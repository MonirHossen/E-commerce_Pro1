    ...
    <div class="container">
        <div class="row">
            ...
            <div class="navbar-logo col-md-3 col-sm-12 col-xs-7">
                <a href="index.html"><img src="{{ asset('assets/front/image/logo.png') }}" title="Your Store" alt="Your Store"></a>
            </div>
            <!-- //end Logo -->
            ...
            <div class="col-md-4 col-sm-4 col-xs-5 shopping_cart pull-right">
                ...
                <div id="cart" class=" btn-group btn-shopping-cart">
                    <a data-loading-text="Loading..." class="top_cart dropdown-toggle" data-toggle="dropdown">
                        <div class="shopcart">
                            <span class="handle pull-left" style="background-image: url('{{ asset("assets/front/image/cart.png") }}')"></span>
                            <span class="number-shopping-cart">0</span>
                            <span class="title">My Cart</span>
                            <p class="text-shopping-cart cart-total-full total-price"> $0.00 </p>
                        </div>
                    </a>
                    ...
                    <ul class="tab-content content dropdown-menu pull-right shoppingcart-box" role="menu">
                        ...
                        <li>
                            <div>
                                ...
                                <p class="text-right"> &nbsp&nbsp; <a class="btn btn-mega checkout-cart" href="{{ route('checkout') }}"><i class="fa fa-share"></i>Checkout</a> </p>
                            </div>
                        </li>
                    </ul>
                </div>
