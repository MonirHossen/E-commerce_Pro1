<!-- Basic page needs
    ============================================ -->
<title>Destino :: @yield('title')</title>
<meta charset="utf-8">
...
<link rel="shortcut icon" href="{{ asset('assets/front/ico/favicon.png') }}">
...
<link href="{{ asset('assets/front/js/owl-carousel/assets/owl.carousel.css') }}" rel="stylesheet">
<link href="{{ asset('assets/front/js/owl-carousel/assets/owl.theme.default.min.css') }}" rel="stylesheet">
